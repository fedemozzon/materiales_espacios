...
urlpatterns = [
    ...
    path('update_material_reservation/', views.update_material_reservation, name='cancel_reserve_material'),
    ...
    path('update_place_reservation/', views.update_place_reservation, name='cancel_reservation'),
